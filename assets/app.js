...
function aboutView() {
  return `<div class="prose">
    ...
    <p>Все раздачи лежат на RuTracker — там же обсуждение и обратная связь:<br>
       <a class="link" href="https://rutracker.org/forum/tracker.php?rid=45603748"
          target="_blank" rel="noopener">rutracker.org — раздачи NonSense</a></p>
